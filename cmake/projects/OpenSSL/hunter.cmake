...
if(MINGW)
  hunter_status_debug("MINGW defined, Scheme: url_sha1_openssl")
  hunter_pick_scheme(DEFAULT url_sha1_openssl)
elseif(WIN32)
  hunter_status_debug("WIN32 defined ==>> openssl 1.1")
  ...
  #  hunter_status_debug("==> url_sha1_openssl_windows")
  # else()
  #  hunter_pick_scheme(DEFAULT url_sha1_openssl_windows_1_1_plus)
  #  hunter_status_debug("==> url_sha1_openssl_windows_1_1_plus")
  # endif()
elseif(APPLE)
  if(IOS)
    hunter_pick_scheme(DEFAULT url_sha1_openssl_ios)
    hunter_status_debug("APPLE defined ==> url_sha1_openssl_ios")
  else()
    hunter_pick_scheme(DEFAULT url_sha1_openssl_macos)
    hunter_status_debug("APPLE defined ==> url_sha1_openssl_macos")
  endif()
else()
  hunter_pick_scheme(DEFAULT url_sha1_openssl)
  hunter_status_debug("DEFAULT ==> url_sha1_openssl_macos")
endif()
